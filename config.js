module.exports = {
    ...
    statusKeywords: [
        ...
        'status aya', 'status dekho', 'status aaya',
        'status update', 'new status', 'latest status'
    ],
    ...
    statusWarningMessage: `⚠️ *Group Alert* ⚠️\n\nStatus mention / share karna iss group mein *sakht mana* hai.\nMehfuz mahol banaye rakhen. Shukriya! 🤝`,

    statusDeleteFailMessage: `⚠️ @{{user}} ne status share/mention kiya.\n(Admin permission ki waja se auto-delete nahi ho saka. Admin manually delete karein.)`
};